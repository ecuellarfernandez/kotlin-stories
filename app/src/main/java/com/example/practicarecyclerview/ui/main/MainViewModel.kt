...
class MainViewModel: ViewModel() {
    val persons = mutableListOf(
        Person(1, "Haniel", "https://i.ytimg.com/vi/aOI07j-YvV8/maxresdefault.jpg").apply {
            storiesImg = mutableListOf(
                "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgvRxXIMjCnTlf4VKuPX-X6pZ-J6U5t02Jdgc2PatyYQ&s",
        ...
        Person(2, "Cheky", "https://i0.wp.com/codigoespagueti.com/wp-content/uploads/2023/09/hora-de-aventura-fionna-and-cake-finn-adulto.jpg").apply {
            storiesImg = mutableListOf(
